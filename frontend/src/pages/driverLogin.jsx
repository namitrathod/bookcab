...
<div className="p-7 h-screen flex flex-col justify-between">
    <div>
        ...
        <form onSubmit={formhandler}>
            ...
            <button className="bg-[#111] rounded text-white font-semibold mb-7 px-2 py-2 w-full text-lg placeholder:text-base" type="submit">Login</button>
        </form>
        <p className='mb-5 text-center'>Join our fleet ? <Link to="/driver-signup" className="text-blue-600">Register as a Driver</Link></p>
    </div>

    <div>
    <button className="bg-[#10b461] rounded text-black font-semibold mb-7 px-2 py-2 w-full text-lg placeholder:text-base" type="button" onClick={() => window.location.href = '/user-login'}>Sign in as User</button>
    </div>
</div>
  )
}
